 ...
 *  slower, but do not modify the array.  This class is specialized for Rationales.
 *  @see `Sorting` for a generic version of this class.
 *  @param a  the array to operate on
 */
class SortingR (a: Array [Rational])
{
...
object SortingR
{
     ...
     */
    def median (a: Array [Rational], k: Int): Rational = (new SortingR (a)).median (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort (a: Array [Rational]) { (new SortingR (a)).qsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort (a: Array [Rational]) { (new SortingR (a)).selsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort2 (a: Array [Rational]) { (new SortingR (a)).qsort2 () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort2 (a: Array [Rational]) { (new SortingR (a)).selsort2 () }
     ...
     *  @param a  the array to be examined
     */
    def imedian (a: Array [Rational], k: Int): Rational = (new SortingR (a)).imedian (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
    def iqsort (a: Array [Rational]): Array [Int] = (new SortingR (a)).iqsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort (a: Array [Rational]): Array [Int] = (new SortingR (a)).iselsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
//  def iqsort2 (a: Array [Rational]) { (new SortingR (a)).iqsort2 () }   // FIX: implement

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort2 (a: Array [Rational]): Array [Int] = (new SortingR (a)).iselsort2 ()

} // SortingR


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingRTest` object is used to test the correctness and performance
 *  of the 'median' and 'imedian' methods in the `SortingR` class.
 */
object SortingRTest extends App
{
    import Timer._
    ...
    val rn = new Random ()
    val n  = 1000000
    val a  = Array [Rational] (9.0, 1.0, 8.0, 2.0, 7.0, 3.0, 6.0, 4.0, 5.0)
    val aa = Array.ofDim [Rational] (n)
    ...
    for (k <- 1 to 5) {
        val med = new SortingR (Array [Rational] (9.0, 1.0, 8.0, 2.0, 7.0, 3.0, 6.0, 4.0, 5.0))
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingRTest2` object is used to test the correctness and performance
 *  of the 'qsort' and 'iqsort' sorting methods in the `SortingR` class.
 */
object SortingRTest2 extends App
{
    ...
    println ("--------------------------------------------------------------")
    val a1 = Array [Rational] (9.0, 1.0, 8.0, 2.0, 7.0, 3.0, 6.0, 4.0, 5.0)
    println ("Test direct: a1 = " + a1.deep)
    val srt = new SortingR (a1)
    srt.qsort ()
    ...
    println ("--------------------------------------------------------------")
    val a2 = Array [Rational] (9.0, 1.0, 8.0, 2.0, 7.0, 3.0, 6.0, 4.0, 5.0)
    println ("Test indirect: a2 = " + a2.deep)
    val isrt = new SortingR (a2)
    rk = isrt.iqsort ()
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingRTest3` object is used to test the correctness and performance
 *  of the 'selsort' and 'iselsort' sorting methods in the `SortingR` class.
 */
object SortingRTest3 extends App
{
    import scala.util.Sorting.quickSort
    import Timer._
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingRTest4` object is used to test the correctness and performance
 *  of the 'qsort2' and 'iqsort2' sorting methods in the `SortingR` class.
 */
object SortingRTest4 extends App
{
    import scala.util.Sorting.quickSort
    import Timer._
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingRTest5` object is used to test the correctness and performance
 *  of the 'selsort2' and 'iselsort2' sorting methods in the `SortingR` class.
 *  Thet sort in decreasing order.
 */
object SortingRTest5 extends App
{
    import scala.util.Sorting.quickSort
    import Timer._
