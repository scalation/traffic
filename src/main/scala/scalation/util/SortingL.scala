...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingLTest` object is used to test the correctness and performance
 *  of the 'median' and 'imedian' methods in the `SortingL` class.
 */
object SortingLTest extends App
{
    import Timer._
    ...
    val rn = new Random ()
    val n  = 1000000
    val a  = Array [Long] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    val aa = Array.ofDim [Long] (n)
    ...
    for (k <- 1 to 5) {
        val med = new SortingL (Array [Long] (9, 1, 8, 2, 7, 3, 6, 4, 5))
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingLTest2` object is used to test the correctness and performance
 *  of the 'qsort' and 'iqsort' sorting methods in the `SortingL` class.
 */
object SortingLTest2 extends App
{
    ...
    println ("--------------------------------------------------------------")
    val a1 = Array [Long] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    println ("Test direct: a1 = " + a1.deep)
    val srt = new SortingL (a1)
    srt.qsort ()
    ...
    println ("--------------------------------------------------------------")
    val a2 = Array [Long] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    println ("Test indirect: a2 = " + a2.deep)
    val isrt = new SortingL (a2)
    rk = isrt.iqsort ()
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingLTest3` object is used to test the correctness and performance
 *  of the 'selsort' and 'iselsort' sorting methods in the `SortingL` class.
 */
object SortingLTest3 extends App
{
    import scala.util.Sorting.quickSort
    import Timer._
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingLTest4` object is used to test the correctness and performance
 *  of the 'qsort2' and 'iqsort2' sorting methods in the `SortingL` class.
 */
object SortingLTest4 extends App
{
    import scala.util.Sorting.quickSort
    import Timer._
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingLTest5` object is used to test the correctness and performance
 *  of the 'selsort2' and 'iselsort2' sorting methods in the `SortingL` class.
 *  Thet sort in decreasing order.
 */
object SortingLTest5 extends App
{
    import scala.util.Sorting.quickSort
    import Timer._
