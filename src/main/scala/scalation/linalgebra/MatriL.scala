 ...
 *  classes implemeting 'Long' matrices.
 */
trait MatriL
      extends Error
{
     ...
     *  @param j   the column index
     */
    def apply (ir: Range, j: Int): VectorL
     ...
     *  @param jr  the column range
     */
    def apply (i: Int, jr: Range): VectorL
     ...
     */
    def update (ir: Range, j: Int, u: VectorL)
     ...
     *  @param u   the vector to assign
     */
    def update (i: Int, jr: Range, u: VectorL)
