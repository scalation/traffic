      ...
      extends MatriD with Error with Serializable
{
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Get the sup-diagonal of the matrix.
     */
    def sd: VectorD = _sd

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Set the sup-diagonal of the matrix.
    ...
    def apply (i: Int, j: Int): Double = 
    {
        ...
        else throw new Exception ("BidMatrixD.apply: element not on diagonals")
    } // apply
     ...
     */
    def apply (ir: Range, jr: Range): BidMatrixD = 
    {
     ...
     */
    def update (ir: Range, jr: Range, b: BidMatrixD)
    {
    ...
    {
        throw new NoSuchMethodException ("values for BidMatrixD should be diagonal")
    } // set
     ...
     */
    def slice (from: Int, end: Int): BidMatrixD =
    {
        val c = new BidMatrixD (end - from)
        for (i <- c.range1) {
            c._dg(i) = _dg(i + from)
     ...
     */
    def slice (r_from: Int, r_end: Int, c_from: Int, c_end: Int): BidMatrixD =
    {
        throw new NoSuchMethodException ("BidMatrixD must be symmetric")
    } // slice
     ...
     */
    def sliceExclude (row: Int, col: Int): BidMatrixD =
    {
        throw new NoSuchMethodException ("BidMatrixD does not support sliceExclude")
    } // sliceExclude
     ...
     */
    def selectRows (rowIndex: Array [Int]): BidMatrixD =
    {
        throw new NoSuchMethodException ("BidMatrixD does not support selectRows")
    } // selectRows
     ...
     */
    def selectCols (colIndex: Array [Int]): BidMatrixD =
    {
        throw new NoSuchMethodException ("BidMatrixD does not support selectCols")
    } // selectCols
    ...
    def t: BidMatrixD =
    {
        throw new NoSuchMethodException ("BidMatrixD does not support transpose")
    } // ++
    ...
    {
        val trid = b.asInstanceOf [BidMatrixD]
	if (d1 == trid.d1) {
            new BidMatrixD (_dg + trid.dg, _sd + trid.sd)
        } else {
     ...
     */
    def + (x: Double): BidMatrixD =
    {
        new BidMatrixD (_dg + x, _sd + x)
    } // +
    ...
    def * (b: MatriD): BidMatrixD = 
    {
        throw new NoSuchMethodException ("BidMatrixD does not support * with general matrices")
    } // *

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Multiply this matrix by matrix b.  Requires b to have type BidMatrixD,
     *  but returns a more general type of matrix.
     *  @param b  the matrix to multiply by
     */
    def * (b: BidMatrixD): MatrixD = 
    {
     ...
     */
    def clean (thres: Double, relative: Boolean = true): BidMatrixD =
    {
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Solve for x in the equation a*x = d where a is this matrix.  FIX
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Helper method for computing the determinant of this matrix. FIX
     ...
     */
    def sum: Double = _dg.sum + _sd.sum

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Compute the sum of the lower triangular region of this matrix.
     */
    def sumLower: Double = 0.0
     ...
     */
    def sumAbs: Double = _dg.norm1 + _sd.norm1
    ...
    //--------------------------------------------------------------------------
    // The following methods are not useful for Bidiagonal matrices:
    //--------------------------------------------------------------------------
    ...
    def solve (lu: Tuple2 [MatriD, MatriD], b: VectorD): VectorD = 
    {
        throw new NoSuchMethodException ("solve lu not implemented")
    } // solve

    def diag (b: MatriD): BidMatrixD = 
    {
        throw new NoSuchMethodException ("diag not implemented")
    } // diag

    def diag (p: Int, q: Int): BidMatrixD = 
    {
        throw new NoSuchMethodException ("diag not implemented")
    } // diag

    def inverse_npp: BidMatrixD = 
    {
        throw new NoSuchMethodException ("inverse: not implemented")
    } // inverse_npp

    def inverse: BidMatrixD = 
    {
        throw new NoSuchMethodException ("inverse: not implemented")
    } // inverse

    def inverse_ip: BidMatrixD = 
    {
        throw new NoSuchMethodException ("inverse_ip not implemented")
    } // inverse_ip

    def reduce: BidMatrixD = 
    {
...
{
    val a = new BidMatrixD (VectorD (1.0, 2.0, 3.0),
                               VectorD (4.0, 5.0))

    val b = new BidMatrixD (VectorD (2.0, 3.0, 4.0),
                               VectorD (5.0, 6.0))
