...
object MatrixD extends Error
{
     ...
     */
    def ++ (u: VectorD, a: MatrixD): MatrixD =
    {
        if (u.dim != a.dim2) flaw ("++", "vector does not match row dimension")

        val c = new MatrixD (a.dim1 + 1, a.dim2)
    ...
    def +: (u: VectorD, a: MatrixD): MatrixD =
    {
        ...
        val c = new MatrixD (a.dim1, a.dim2 + 1)
 ...
 *  > scalation.linalgebra.MatrixDTest
 */
object MatrixDTest extends App
{
    ...
    println ("csv = " + MatrixD ("data/matrices/matrix.csv"))

    bb.write ("data/matrices/bb_matrix.csv")
    println ("bb_csv = " + MatrixD ("data/matrices/bb_matrix.csv"))
