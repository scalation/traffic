...
import scalation.util.SortingI.qsort2
      ...
      extends Traversable [Int] with PartiallyOrdered [VectorI] with Error with Serializable
{
     ...
     */
    def normalize: VectorI = this * (1 / sum)
     ...
     */
    def norm: Int = sqrt (normSq).toInt
