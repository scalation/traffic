 ...
 */
class MG1_Queue (lambda: Double, mu: Double, cv: Double = 1.0, c: Int = 1)
      extends Error
{
     ...
     //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
     /** Probability system is empty.    // FIX
      */
     def prob_0: Double =
     {
      ...
      */
     val t_q = rho * (1.0 + cv * cv) / ( 2.0 * mu * (1.0 - rho)) 
