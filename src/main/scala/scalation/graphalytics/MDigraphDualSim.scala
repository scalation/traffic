...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigraphDualSim` class provides a second implementation for Dual Graph Simulation.
 *  It differs from DualSim by not using inverse adjacency sets ('par') in
 *  order to save space.
 *  @param g  the data graph  G(V, E, l)
 *  @param q  the query graph Q(U, D, k)
 */
class MDigraphDualSim (g: MDigraph, q: MDigraph)
...
//                  val v_c = g.ch(v)                                          // don't filter on edge labels
                    ...
                    val phiTemp = v_c & phi(u_c)                  // children of v contained in phi(u_c)
                    if (phiTemp.isEmpty) {
...
} // MDigraphDualSim class


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigraphDualSimTest` object is used to test the `MDigraphDualSim` class.
 *  run-main scalation.graphalytics.MDigraphDualSimTest
 */
object MDigraphDualSimTest extends App
{
    ...
    val matcher = new MDigraphDualSim (g, q)               // Graph Simulation Pattern Matcher
    val phi     = time { matcher.mappings () }             // time the matcher
    println ("MDigraphDualSim ---------------------------------------------")
    matcher.showMappings (phi)                             // display results

} // MDigraphDualSimTest object


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigraphDualSimTest2` object is used to test the 'MDigraphDualSim' class.
 *
object MDigraphDualSimTest2 extends App
{
    ...
    val matcher = new MDigraphDualSim (g, q)                      // Dual Graph Simulation Pattern Matcher
    val phi     = time { matcher.mappings () }             // time the matcher
    for (i <- phi.indices) println ("u_" + i + ": " + phi(i)) 

} // MDigraphDualSimTest2 object
 */
